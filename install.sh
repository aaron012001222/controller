...
echo -e "${GREEN}=============================================${NC}"
echo -e "由于开启了全自动 SSL，请直接使用您的域名访问："
echo -e "管理后台 : https://您的域名/$RANDOM_PATH"
echo -e "服务器 IP: ${SERVER_IP:-$CURRENT_IP}"
echo -e "账号     : ${ADMIN_USER:-$RANDOM_USER}"
echo -e "密码     : ${ADMIN_PASS:-$RANDOM_PASS}"
echo -e "---------------------------------------------"
echo -e "【重要提示】"
echo -e "1. 请确保您的域名已解析到本机 IP，且 Cloudflare 小黄云已关闭 (DNS Only)。"
echo -e "2. 首次访问 https 时可能会慢几秒钟（正在申请证书），之后会秒开。"
echo -e "3. 请务必在后台将该域名添加到系统中，否则 Auto-SSL 会拒绝申请证书。"
echo -e "${GREEN}=============================================${NC}"